...
iptables -A INPUT -s 192.168.0.11 -p tcp -m multiport --dports 2376,2377,7946 -j ACCEPT
iptables -A OUTPUT -d 192.168.0.11 -p tcp -m multiport --sports 2376,2377,7946 -j ACCEPT
